...
import type { ChipTone, Persona } from "../types/domain";

const CHIP_ICONS: Record<ChipTone, LucideIcon> = {
  green: Smile,
...
export default function PersonaCard({ persona, selected, met, onSelect }: PersonaCardProps) {
