...
import type { OpenConversation, UserProfile } from "../types/domain";

type SidebarProps = {
  openConversations: OpenConversation[];
  activeId: string | null;
  profile: UserProfile | null;
  onSelect: (conversation: OpenConversation) => void;
  onCloseChat: (id: string) => Promise<void> | void;
...
export default function Sidebar({
  ...
  const [pendingRemove, setPendingRemove] = useState<OpenConversation | null>(null);

  function navAction(action: () => void) {
    onClose();
    action();
  }
              ...
              >
                ...
                >
                  ...
                  <div style={{ fontSize: 11, color: "rgba(255,255,255,0.5)", display: "flex", alignItems: "center", gap: 5, marginTop: 1 }}>
                    <GradeBadge grade={c.client_grade || "Medium"} />
