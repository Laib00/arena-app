import type { DiscChip, DiscType } from "./types/domain";
...
export const DISC: Record<DiscType, { name: string; desc: string }> = {
...
export const DISC_CHIPS: Record<DiscType, DiscChip[]> = {
  D: [
...
export const EDU_LEVELS = [
  ...
  "Bachelor's Degree",
  "Master's Degree",
  "Professional Certification / PhD",
] as const;
